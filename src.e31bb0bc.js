...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../js/task-1.js":[function(require,module,exports) {
...
var logSuccess = function logSuccess(id, time) {
  return console.log("Transaction ".concat(id, " processed in ").concat(time, "ms"));
};

var logError = function logError(id) {
  return console.warn("Error processing transaction ".concat(id, ". Please try again later."));
};
...
require("../js/task-3");
},{"../js/task-1":"../js/task-1.js","../js/task-2":"../js/task-2.js","../js/task-3":"../js/task-3.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
